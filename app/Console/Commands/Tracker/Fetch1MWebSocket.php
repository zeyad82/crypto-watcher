...
class Fetch1MWebSocket extends Command
{
    protected $signature   = 'tracker:fetch-1m-websocket';
    ...
    //         $minTimestamp = Carbon::now()->subMinutes(49 * 1);
    ...
    //     }
        ...
        $streams = implode('/', array_map(fn($symbol) => str_replace('/', '', strtolower($symbol)) . '@kline_1m', $cryptoSymbols));
